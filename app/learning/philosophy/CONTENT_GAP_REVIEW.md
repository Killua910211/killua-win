...
## 2026-09-25：人物历史结构重构（本地自审）

- **Medium／已改善：**姓名排序缺少历史逻辑。默认改为五组、22 个阅读阶段、25 人；原 12 人锚点保留，首页改为传统入口。
- **Medium／已改善：**补入柏拉图、孔子、庄子、王阳明、牟宗三、龙树、商羯罗、马克思、尼采、伊本·西那、奥鲁卡的历史概览；阿奎那与弗里克复用既有精读。14 人为问题精读入口，11 人为概览，页面明确区分。
- **High／保留边界：**新元数据的日期仅说明所列 SEP／IEP 章节已核对；旧问题来源账的待核验状态与日期保持不变。原典版本、译者、页码尚未全部完成，概览不是完整研究条目。
- **Medium／待补：**秦汉至隋唐、清代、印度近现代、伊斯兰后古典／近现代等保留空段与具体研究方向；日本、韩国及更多地区没有被中国或印度代替。
- **Low／待深化：**学派为多值导航标签，配逐人限定及依据；比较链接只表示对读，不生成影响边。尚未独立复审。

## 2026-09-25：人物阅读入口首版（历史自审）

- **Medium／已改善：**人物论证散在问题页，无法从名字开始阅读。新增 12 人的索引，精确映射至既有论证与文本段落，问题页和历史页反向链接同一人物记录。正文与来源不复制成第二份事实源。
- **High／保留边界：**来源账存在待核验条目；人物阅读门槛按实际引用检查，不按整页或同 URL 的其他记录继承核验状态。没有把来源条目的旧核验日期改成本轮日期。
- **Medium／下一步：**印度与非洲大陆人物缺少完整人物级入口；先补具体论争、可定位文本与反方，再收录。柏拉图、孔子、荀子等要辨明人物与传世／集体文本的归属；罗尔斯、库恩等需先处理所用阅读材料的待核验记录。
- **Low／后续：**证据充分后补原文名、异译和同名消歧；跨问题综合需求明确时再开人物详页，不按名单批量生成简传。

设计经 ChatGPT 第二意见后由 Codex 实施；尚未独立复审。实现、授权状态与验收见 [当前任务](../../../docs/tasks/current-task.md)。

## 2026-09-24：人物与学派补充（本地自审）

本轮核对线上学习入口、近当代与中国后期历史页，并检查本地 55 节点的名称、正文、来源及连接。
维持 55 节点；修改六个历史条目，新增 14 条实际打开并定位的来源，更新现象学与梵论两条已有来源的核验范围。
没有独立审查；ChatGPT 顾问建议的接收状态及验收证据见 [当前任务](../../../docs/tasks/current-task.md)。

### High：先修正误导

- **维特根斯坦前后期**：原人物段把两期都概括为反对意义脱离使用。改为前期命题图像与逻辑形式、后期具体用法，并新增 CONP-8；移除胡塞尔、维特根斯坦与杜威方案「互不相容」的无依据断语。
- **朱熹／王阳明**：原入口、人物和例子把两人写成向外／向内，甚至说心与理是两件需接通的事。依 CHL-7、CHL-8 改为修养工夫与知行关系的争论，修正「没有经文之外的裁决处」的绝对说法。
- **梵与人格神**：原正文与关系理由统一排除人格性，和同页吠檀多诸派有分歧的说明矛盾。依 VED-2 收窄，比较时须指明派别；不把印度思想统一成不二论。
- **怀疑论与经验论的线性叙述**：不再把学园派与皮罗派合成同一主张；不再说休谟的结论由洛克必然推出。没有据此宣称已重审全部古代／近代叙述。

### Medium：补上可继续追问的论证

| 条目 | 补充内容及争点 | 来源 |
| --- | --- | --- |
| 古典与希腊化 | 塞克斯都：悬置与行动；普罗提诺／新柏拉图主义：一与多、单纯原因的代价 | WES-3、WES-4 |
| 中世纪 | 奥卡姆／唯名论：概念怎样指称多个个体；剃刀不是「最简单必为真」 | MED-2 |
| 近代 | 贝克莱：感知前提、非物质论与经验稳定性，上帝前提不可省略 | MOD-3 |
| 近当代 | 皮尔士—詹姆斯—杜威的探究；梅洛-庞蒂的身体；逻辑经验主义的证实难题；法兰克福学派的批判根据 | CONP-1、CONP-5～8 |
| 中国后期 | 王弼言象意及中文研究；戴震的情欲、理与规范；朱王误读修正 | CHL-5～8 |
| 吠檀多及邻近比较 | 自在黑／数论：神我与自性、多神我；帕坦伽利／古典瑜伽：训练与解脱 | VED-5、VED-6 |

新增八条历史语境关系，更新两条已有历史关系与一条跨传统比较理由。连接包括知识、语言、身心、科学、正当性与行动伦理，均说明可以追问什么及不能等同什么。

### 仍保留的缺口

- 新增的是入门论证，不是每位哲学家的专论；多数来源仍是 SEP／IEP，未冒充读过所推荐的整部原典。
- 中国近现代转型、汉语佛教各宗的专门论争、德国观念论的内部论证、弥曼差、原住民与非洲大陆当代哲学，仍需专门材料与原典对读。
- 王弼本轮核对的是中文研究论文中《明象》的引录和论证；戴震、数论与瑜伽尚未对读可靠中文原典译校本。
- 来源链接与语义已逐条核验；桌面和窄屏只抽查修改页，不把构建或路由通过写成全站视觉回归完成。
