...
export const comparativeQuestions: ComparativeQuestion[] = [
  {
    ...
    framings: [
      ...
      },
      {
        ...
        note:
          '这一侧的关键不是「无原因」，而是源头：自由要求「我们致使某些事发生，而没有任何东西、任何人致使我们去如此致使」。该要求会逼出一个它自己也难受的两难——若一切被决定，源头总落在我之外；若引入非决定性，选择又可能只是随机而非受控。操纵与设计案例是这条路线的主要直观支撑，但同一份综述也指出它有循环之嫌：它先假定了追溯到不可控源头的因果会破坏自由。',
        sourceIds: ['AG-2'],
      },
      {
        tradition: '康德的自我立法',
        ...
        note:
          '康德不问「我的选择有没有原因」，而问一个意志在什么条件下算是自己在立法。综述的表述是：自由在于「受某种意义上由自己制定的法则约束」，理性意志必须「在自身自由的理念下」行动，依照「我们是其源头或作者」的普遍法则运作。「属于我自己」在这里是一个规范条件，不是一段因果史的性质。',
        sourceIds: ['AG-3'],
      },
      {
        tradition: '儒家的修养与礼',
      ...
      },
      {
        tradition: '佛教的业与相续',
        nodeId: 'pt-buddhist',
        caresAbout: ['意向与造作', '业果如何在无常一之我的前提下相续', '执取的作用', '修行改变条件'],
        note:
          '佛教一侧先取消了提问的一个预设。综述的陈述是：业果由行动而非由一个转生的灵魂承载，因而「无转生的再生在逻辑上是可能的」；前世之人与今世之人「既非同一亦非不同」。归属问题于是从「谁是这个行动的所有者」转成「哪些条件在相续、哪些造作还在起作用」。',
        sourceIds: ['AG-5'],
      },
    ],
    caution:
      '这五栏不是同一道题的五个答案。相容论与源头性要求在争一个概念分析：使行动自由的条件是什么。康德争的是规范条件，这可以在因果问题悬置的情况下成立。儒家的核心问题是养成——怎样使一个人的反应变得可靠，而不是划出自由行动的边界。佛教连「行动有一个持续的所有者」都不接受，它要处理的是苦与解脱。把它们排成一排，最容易做实的正是几条对不上的等式：儒家没有主张「决定论与自由相容」，佛教也没有主张「一切被决定」——缘起讲的是条件相依，不是可预测的必然。',
    pending: [
  ...
  },
  {
    ...
    framings: [
      {
        ...
        nodeId: 'pt-mind-self',
        caresAbout: ['持存的必要充分条件', '心理连续性与记忆', '裂变案例', '动物论与纯物理连续性'],
        note:
          '这一支把问题定为持存问题：「一个过去或未来的存在者要成为现在的某人，需要什么是必要且充分的」。心理连续论的一个版本说，某个过去或未来的存在者就是你，只要你现在能记起她当时的某个经验，或反之；动物论一侧则主张我们就是有机体，持存靠「纯物理的连续性」。争的是数目上的同一关系该由什么担保。',
        sourceIds: ['PI-1'],
      },
      {
        tradition: '佛教的无我分析',
    ...
    caution:
      '两边表面上都在谈「什么支撑同一」，目标却不同。持存问题要一个真值条件：某个未来存在者究竟是不是数目上的我。佛教的无我分析是一套实践—解脱论断言的一部分，它要说明的是执取一个常一之我如何产生苦，而不是给同一关系补一个更好的判准。所以不能把「无我」读成心理连续论或还原论的东方版本：帕菲特式还原论仍在回答持存问题，佛教则同时主张这个问题在究竟层面上问错了。反方向也要小心：无我并不否认日常人格、记忆或责任，佛教文本在世俗层面照样使用「人」。',
    pending: [
    ...
    sources: [
      {
        ...
        checkedOn: '2026-09-11',
        supports:
          '持存问题的表述（一个过去或未来的存在者要成为现在的某人需要什么）；心理连续论的记忆条件；动物论以纯物理连续性说明持存；§1 明确把人格问题与持存问题列为大体独立的两问。',
      },
      {
        id: 'PI-2',
        title: 'SEP：Buddha',
    ...
    framings: [
      {
        ...
        note:
          '争点是一次认知的「量性」（prāmāṇya）内在自具还是靠别的东西确立。弥曼差与吠檀多一方由后退威胁推出知识自我证成（svataḥ prāmāṇya）；正理一方持外在确立说（parataḥ prāmāṇya），明确否认「知 p」蕴含「知道自己知 p」。综述把正理描述为主张知识对自身之为真并不自觉的学派，量性要通过后察与来源识别一类程序在事后确立。',
        sourceIds: ['CR-1'],
      },
      {
        tradition: '当代内在主义／外在主义之争',
        nodeId: 'pt-knowledge-sources',
        caresAbout: ['证成随附于什么', '心理状态说与可通达说', '真值导向性', '新恶魔案例与超感知案例'],
        note:
          '当代这场争论的轴是随附关系：内在主义主张「证成随附于内在之物」，内在复本必有同样被证成的信念；外在主义否认这一随附。「内在」有两种理解方式——心理状态说（随附于思者心理生活的相关方面）与可通达说（随附于可经反思或内省通达的条件）。支持外在主义的主要理由是真值导向性与解释力，支持内在主义的主要理由包括证成的规范性以及「被欺骗者与我们证成相同」这一直观。',
        sourceIds: ['CR-2'],
      },
    ],
    caution:
      '两场争论共用一个后退结构，却不是同一道题。印度这一场的直接问题是「知道自己知道」——正理否认的是 Kp 蕴含 KKp，争的是量性如何被确立与认定。当代这一场问的是证成随附于什么，其中「内在」被定义成心理状态或可反思通达之物，与「自觉」并不重合。所以「正理＝外在主义」这个对应会误导：外在确立说完全可以与一种关于证成的内在主义并存，反过来也一样。要把这个对应做实，必须逐项说明两边的「内／外」各指什么——本条没有做到这一步，只指出两者共用后退难题。',
    pending: [
  ...
  },
  {
    ...
    framings: [
      ...
      },
      {
        ...
        note:
          '这一支把矛头指向归纳所预设的齐一原则：「未经验的事例必与已经验者相似，自然的进程始终齐一」。两难的形式是：论证式推理不能确立它，因为自然改道并不自相矛盾，人可以清楚分明地设想已有规律在未观察情形中不成立；概然推理也不能，因为一切概然推理都已「预设将来将与过去一致」，用它来证明齐一原则就是「把正待论证之点当作前提」。',
        sourceIds: ['UO-2'],
      },
    ],
    caution:
      '相似之处止于被质疑的那一步。休谟的问题是一个普遍的辩护问题，牵动全部经验科学，那份综述的大半篇幅都在排列各种回应方案；顺世论的动机是特定的——限制形上学与宗教结论，日常推理照用。所以顺世论不是「印度的休谟」，它没有主张全部归纳都缺乏辩护。还有一层不对称落在材料上：休谟的文本完整可读，顺世论的观点主要靠残片与对手转述重构，任何「顺世论主张 X」的说法都得先说清 X 出自哪份材料。',
    pending: [
  ...
  },
  {
    ...
    why:
      '中世纪的预知难题与当代自由意志争论共用同一台机器：一条关于过去之事已经固定的前提，加上一条必然性可沿蕴含关系传递的规则，推出行动者现在不能不做某事。差别只在那个已固定的事实是神的信念，还是远古的世界状态加自然律。',
    ...
    framings: [
      {
        ...
        note:
          '中世纪几乎所有作者都同时肯定神全知与人自由，问题因此是内部的：若神已知我将如何行动，「它们如何还能是自由的，既然看来我不能有别的意愿或行动」。波爱修不把它当成单纯的逻辑谬误，而提出「凡被认知者，不是按其自身的力量被把握，而是按认知者的能力被把握」，让未来偶然事件在自身层面保持未定，阿奎那沿此路走。奥卡姆与司各脱另走一路，主张神必须偶然地意愿，并因此拒绝把必然性等同于时间上的恒常。阿维森纳与阿威罗伊把神的知识限于普遍者以避开难题，迈蒙尼德诉诸神的不可知与关于神之知识的歧义语言。',
        sourceIds: ['FK-1'],
      },
      {
        ...
        note:
          '当代重构把这个推理排成十步：神昔日无误地相信某行动将发生；过去之事仅因其为过去即为必然；故神昔日的信念必然；若神如此相信则该事必发生；必然性沿蕴含传递；故该行动现在必然；必然之事不能不做；故行动者不能不做；无替代可能即无自由；故该行动不自由。排开之后，回应就是逐条挑其中一步：永恒方案否认「昔日相信」适用于神，因为神并无时间中的信念；软事实方案区分纯粹关于过去的硬事实与部分关于未来的软事实，并把神关于未来偶然者的信念归入后者。',
        sourceIds: ['FK-2'],
      },
      {
        tradition: '世俗自由意志争论',
        ...
        note:
          '把「神的信念」换成「远古的世界状态加自然律」，骨架不变：后果论证由过去的固定性与自然律的固定性出发，经一条传递规则得出，若决定论为真，「对任何真命题 p，没有人对 p 是否成立有过任何选择」。这也解释了为什么两边的回应形式相似——或否认必然性可以这样传递，或否认自由需要替代可能。',
        sourceIds: ['FK-3'],
      },
    ],
    caution:
  ...
  },
  {
    ...
    framings: [
      ...
      },
      {
        ...
        note:
          '伊壁鸠鲁把目标定在无扰动：对死亡等的恐惧一旦消除即是 ataraxia，它与身体无痛一起构成人生目标的一种表述。关键的技术区分是动态快乐（如宜人的气味或声音）与静态快乐（「伴随安好本身的快乐」，是状态而非过程）；由此得出快乐「不因持续时间而增加」，完全免于身体痛苦已是量表的绝对顶端。',
        sourceIds: ['GL-2'],
      },
      {
        tradition: '斯多亚的唯德是善',
        ...
        note:
          '斯多亚把好生活的内容压到一点：唯有德性是善，「唯有德性使人受益」；健康、财富、名声「既不使人受益也不使人受损」，故非善非恶。但主流斯多亚不让所有无关者等价——健康、财富、名声属被优选的一类，合乎自然，选取它们因而是恰当的。综述也指出这产生解释困难：某物既与幸福无关，又值得理性地追求，看来自相矛盾。由于德性只取决于赞同，而赞同在我们能力之内，幸福「也将在行动者的能力之内、完全由他决定」。',
        sourceIds: ['GL-3'],
      },
      {
        tradition: '当代福祉理论',
        ...
        note:
          '当代讨论先把问题切开：福祉是一种「审慎价值」，要与美学价值或道德价值区分开。综述举的对照是，一幅画的美学品质是好的，却不是「对那幅画好」；捐款可能有道德价值并使他人受益，但「我在道德上是好的是否对我好，仍是一个未决问题」。只有切开之后，快乐论、欲望论与客观清单论才是在同一个问题上竞争。',
        sourceIds: ['GL-4'],
      },
    ],
    caution:
      '把德性、宁静、快乐说成「三个答案回答同一道题」走得太快。三个古典学派不只在答案上分歧，在「答案要满足什么」上也分歧：亚里士多德要一个能指导终身活动与教育的人的善；伊壁鸠鲁要一套解除恐惧与欲望的疗法，快乐的上限就在痛苦解除处，因此它不需要一个可以无限累加的量表；斯多亚要一个使幸福完全不受运气支配的方案，代价是把健康与财富逐出「善」的范畴，而这个代价连他们自己的解释者都觉得难安。当代福祉理论问的又是别的东西——「对我好」这一关系，它明确把道德上的好与对我而言的好分开，而古典方案通常不接受这个切分。所以不能把「德性论」直接读成一种客观清单论。',
    pending: [
    ...
    framings: [
      {
        ...
        note:
          'fa 指「一整套非人格的规范、法律、条例与制度方案」，被认为「比习惯性地诉诸在位者的个人能力更可靠」，要解决的是国家的治理难题。君主的位置最能看出这套规范朝哪个方向用力：他有权、甚至有责任在情势要求时更改法，同时被极力劝阻不要对现行法作任性干预；综述还指出这一传统的一个悖论——制度被设计成即使君主不贤不智也能运转。同一份综述另外警告，「Legalist」这个标签把研究单一化地绑到「与西方 rule of law 概念的关系」上，一旦 fa 思想的丰富与复杂被压缩为这一点，讨论就变得反效果。',
        sourceIds: ['FA-1'],
      },
      {
        tradition: '现代法治理想',
        ...
        note:
          '现代法治的分界线正好落在上一栏留空的地方：「以法而治（rule by law）几乎不对统治者施加任何法律义务」，而法治「要求对法的义务同等地适用于统治者与被统治者」；其典型形态是国家用法来控制公民，却尽力不让法被用来控制国家。形式要件包括一般性、公开性、不溯及既往、可理解、一致、可行、稳定与吻合；程序要件包括独立公正的裁判、律师代理、在场与质证、听取裁判理由。还有一处不对称：对普通人，未被明文禁止者即被允许；对国家与官员，则可能采取相反的推定——只能依明确的法律授权行事。是否把人权一类实质内容算入核心要件，本身仍有争议。',
        sourceIds: ['FA-2'],
      },
    ],
    caution:
  ...
  },
  {
    ...
    why:
      '「是不是人」在中文里像一道是非题，但两边都发现它至少含两问：某物凭什么算作人格，以及一个人的人格地位能不能有程度、能不能被达成或失去。双方都在这个分叉上明确表态，只是各自接住了不同的一支。',
    ...
    framings: [
      {
        ...
        note:
          '这一支明确把人格当作成就：「一个个体可以是人类而不是人格」，人格地位要求符合某些基本规范与理想，由习惯性行为养成的品性来决定。该条目的题词取自门基提，强调人格「是必须去达成的那种东西」，经由「履行由自己的身分所界定的各种义务」而达成。条目还提出一个更强的主张：在这种道德里「义务胜过权利，而不是相反」，并把它与西方社会的道德体系对置——这是撰稿人本人的比较判断，不是学界的中立描述。',
        sourceIds: ['PH-1'],
      },
      {
        tradition: '分析形而上学对「人格问题」的处理',
        nodeId: 'pt-mind-self',
        caresAbout: ['人格问题与持存问题的分离', '「人格」一词的定义与适用条件', '我们根本上是什么', '判准而非地位'],
        note:
          '这一支先把问题拆成互相独立的几问，其中两问最相关：人格问题——「成为一个人格、而非非人格，是怎么一回事？我们这些人有什么是非人所缺的？」；持存问题——「一个人格要从一个时刻持续到另一个时刻，需要什么？」条目强调这两问「大体上互相独立」。这里的人格问题要的是「人格」一词的定义与适用条件，不是一个可以做得更好或更差的地位。',
        sourceIds: ['PH-2'],
      },
    ],
    caution:
    ...
    pending: [
      'SEP African Ethics 由 Kwame Gyekye 撰写，「人格是达成的」「义务胜过权利」都是他本人的立场陈述。要区分门基提的强共同体主义与吉耶凯自己的温和共同体主义，必须核对 Menkiti 1984 与 Gyekye 1997 原文，本轮没有做——因此 pt-african-personhood 页面上的三条立场目前仍缺各自的独立来源，不能用这一条来支撑其中任意一条。',
    ...
    sources: [
      {
        ...
        checkedOn: '2026-09-11',
        supports:
          '一个个体可以是人类而不是人格，人格地位需符合基本规范与理想并由品性决定；条目题词引门基提「人格是必须去达成的那种东西」，经由履行身分所界定的义务而达成；§9 主张在这种道德中义务胜过权利，并与西方道德体系对置（撰稿人为 Kwame Gyekye，此为其本人立场）。',
      },
      {
        id: 'PH-2',
        title: 'SEP：Personal Identity',
        kind: '学术综述',
        url: 'https://plato.stanford.edu/entries/identity-personal/',
        locator: '§1 The Problems of Personal Identity（人格问题与持存问题的措辞及二者大体独立的说明）',
        checked: 'verified',
        checkedOn: '2026-09-11',
        supports:
          '§1 列出特征、人格、持存、证据、数量、人格本体六问；人格问题问「成为一个人格而非非人格是怎么一回事」，持存问题问「一个人格要从一个时刻持续到另一个时刻需要什么」，并说明两问大体独立。',
      },
    ],
  },
];
