...
export const comparativeQuestions: ComparativeQuestion[] = [
    ...
    framings: [
      {
        ...
        note:
          '相容论把「属于我」拆成可以逐项检查的心理结构，检查的位置在因果链条的最后一段。层级式的版本看行动出自的那个意志是不是行动者自己想要的——一阶欲望与二阶态度对得上；理由响应式的版本不看这个，只问行动所出自的意志机制对理由敏不敏感，因此不要求当时另有一种可能。两条路都不试图让行动摆脱因果。',
        sourceIds: ['AG-1'],
      },
      {
      ...
      },
      {
        ...
        note:
          '儒家追问的不是某个瞬间的选择是否自发，而是一个人的反应从哪里来、能不能被改造。重量因此落在礼与乐上：按综述的说法，礼不只标示什么有价值，还改造欲望、把道德倾向养成起来；《论语》17.2 讲人的差别出在「习」上。于是「属于我自己」在这一栏指向性情的来历——一个行动更像我自己的，是因为它出自被长期塑造过的性情，而不是因为它摆脱了塑造。',
        sourceIds: ['AG-4'],
      },
      {
        tradition: '佛教的业与相续',
        ...
        note:
          '佛教一侧先取消了提问的一个预设：行动背后不必有一个持续的所有者。按综述，承载业果的是行动本身而不是一个转生的灵魂，所以可以有再生而没有一个从这一世搬到下一世的灵魂，前世之人与今世之人「既非同一亦非不同」。归属问题于是从「谁是这个行动的所有者」转成「哪些条件在相续、哪些造作还在起作用」。',
        sourceIds: ['AG-5'],
      },
    ],
    caution:
  ...
  },
  {
    ...
    framings: [
      ...
      },
      {
        ...
        note:
          '佛教一侧不为这个「同一」找担保，而是拆掉提问的形式。无常论证是：若有我则我应常，构成身心的五类要素（五蕴）无一是常，故无我；控制论证从「若有我，人绝不会希望它改变」入手。世亲一路的还原分析并不取消「人」的说法：「人」指的就是这五类要素的集合，在世俗层面照样可用，只是究竟层面可以还原为刹那生灭的诸要素；相续靠因果关联与业的条件维持，而不靠一个持续的主体。',
        sourceIds: ['PI-2', 'PI-3'],
      },
    ],
    caution:
    ...
    framings: [
      {
        ...
        note:
          '争点是一次认知的「量性」（prāmāṇya）从哪里来。量性指一次认知够不够格算作「量」——它是不是由一个可靠的过程生成、算不算真知。弥曼差与吠檀多一方由后退威胁推出知识自我证成（svataḥ prāmāṇya）：一次认知的可靠性由它自身带来，不需要另一次认知去确认。正理一方持外在确立说（parataḥ prāmāṇya）：一次认知不会自己知道自己为真——按这一派的说法，「知道 p」并不自动带来「知道自己知道 p」——所以量性要靠事后的复查与来源辨认一类程序才能确立。',
        sourceIds: ['CR-1'],
      },
      {
        ...
        note:
          '当代这场争论围绕一个「随附」关系展开：说证成随附于某一类事实，意思是两个人在那一类事实上完全相同，信念被证成的情况也必定相同。内在主义主张这一类事实全在当事人内部，外在主义否认。「内部」有两种理解：心理状态说把它定为当事人心理生活的相关方面，可通达说把它定为当事人一经反思或内省就能知道的条件。支持外在主义的主要理由是真值导向性（证成之所以重要，是因为它使信念更可能为真）与解释力；支持内在主义的主要理由包括证成的规范性，以及「一个被恶魔彻底欺骗的人，其信念与我们同样被证成」这一直观。',
        sourceIds: ['CR-2'],
      },
    ],
    caution:
      '后退结构是共用的，被追问的东西却不是一件。印度这一场的直接问题是「知道自己知道」：正理否认的是「知道 p 就自动知道自己知道 p」，争的是量性如何被确立与认定。当代这一场问的是证成随附于什么，而这里的「内」被定为心理状态，或一经反思即可知道的条件，与「自觉」并不重合。所以「正理＝外在主义」这个对应会误导：在量性问题上持外在确立说，完全可以同时在证成问题上是内在主义者，反过来也一样。要把这个对应落实，必须逐项说明两边的「内／外」各指什么——本条没有做到这一步，只指出两者共用后退难题。',
    pending: [
    ...
    framings: [
      {
        ...
        note:
          '顺世论常被简化成「只承认知觉」，可核对的陈述要细一层：并非所有种类的推理都有问题，为了过日常生活，推理是必要的一步。他们区分依概然作出的推理与依确定作出的推理，烟从建筑物升起因而屋内很可能有火就是那个常用例子；被拒绝的是「关于从未被知觉之物的推理，即神与来世」。这一栏的证据基础本身很薄：并无现存的顺世论教义文本，《Bṛhaspati Sūtra》只剩残片。',
        sourceIds: ['UO-1'],
      },
      {
        tradition: '休谟的归纳问题',
        ...
        note:
          '这一支追问的是归纳所预设的齐一原则：「未经验的事例必与已经验者相似，自然的进程始终齐一」。两难的形式是：论证式推理（结论的反面会引出矛盾的那一类）不能确立它，因为自然的进程改变并不自相矛盾，人完全可以清楚地设想已有规律在未观察的情形中不再成立；概然推理也不能，因为一切概然推理都已「预设将来将与过去一致」，用它来证明齐一原则就是「把正待论证之点当作前提」。',
        sourceIds: ['UO-2'],
      },
    ],
    caution:
    ...
    framings: [
      {
        ...
        note:
          '中世纪几乎所有作者都同时肯定神全知与人自由，问题因此是内部的：若神已知我将如何行动，这些行动如何还能是自由的——看来我并不能有别的意愿或别的做法。波爱修不把这个难题当成单纯的逻辑谬误，而提出「凡被认知者，不是按其自身的力量被把握，而是按认知者的能力被把握」，让未来偶然事件在自身层面保持未定，阿奎那沿此路走。奥卡姆与司各脱另走一路，主张神必须偶然地意愿，并因此拒绝把必然性等同于时间上的恒常。阿维森纳与阿威罗伊把神的知识限于普遍者（一般的、可重复的东西，而不是一件件具体事情）以避开难题；迈蒙尼德则诉诸神的不可知，并主张「知道」一词用在神身上与用在人身上并不是同一个意思。',
        sourceIds: ['FK-1'],
      },
      {
        ...
        note:
          '当代重构把这个推理排成十步：神昔日无误地相信某行动将发生；过去之事仅因其为过去即为必然；故神昔日的信念必然；若神如此相信则该事必发生；必然性可以从前件传到后件（前件必然、且有前件就必有后件，则后件也必然）；故该行动现在必然；必然之事不能不做；故行动者不能不做；无替代可能即无自由；故该行动不自由。摆成十步之后，回应无非是挑其中一步来否认：永恒方案否认「昔日相信」适用于神，因为神并无时间中的信念；软事实方案区分纯粹关于过去的硬事实与部分关于未来的软事实，并把神关于未来偶然者的信念归入后者。',
        sourceIds: ['FK-2'],
      },
      {
        tradition: '世俗自由意志争论',
  ...
  },
  {
    ...
    framings: [
      ...
      },
      {
        ...
        note:
          '斯多亚把好生活的内容压到一点：唯有德性是善——只有它使人受益；健康、财富、名声既不使人受益也不使人受损，因而非善非恶。但主流斯多亚不让所有无关者等价——健康、财富、名声属被优选的一类，合乎自然，选取它们因而是恰当的。综述也指出这产生解释困难：某物既与幸福无关，又值得理性地追求，看来自相矛盾。由于德性只取决于赞同（心里接不接受呈现给它的那个判断），而赞同在我们能力之内，幸福「也将在行动者的能力之内、完全由他决定」。',
        sourceIds: ['GL-3'],
      },
      {
        tradition: '当代福祉理论',
  ...
  },
  {
    ...
    framings: [
      {
        ...
        note:
          'fa 是一整套非人格的规范、法律、条例与制度方案，它要解决的是国家怎么治理的问题。君主的位置最能看出这套规范朝哪个方向用力：他有权、甚至有责任在情势要求时更改法，同时被极力劝阻不要对现行法作任性干预。综述还指出这一传统的一个悖论——制度被设计成即使君主不贤不智也能运转。',
        sourceIds: ['FA-1'],
      },
      {
        tradition: '现代法治理想',
    ...
    caution:
      '共同点是真的，差别落在被保护的对象上。fa 传统的规范首先向下和向内运作——约束民与官，使国家可治；现代法治的定义性要求则是把义务同等地施加到统治者自己身上。所以「法家＝早期法治」是错的；但只写这一句否定也不够，因为「以法而治」这个概念恰好说明二者共享的是制度技术，分歧在于法对权力的方向。还要接住综述自己的提醒：「Legalist」这个标签会把研究窄化成一个问题——它与西方的 rule of law 是什么关系；一旦只从这个角度看 fa，就会漏掉这套思想对官僚考核、赏罚与君主自我抑制的关切，而那些才是它的主要议题。',
    pending: [
  ...
  },
  {
    ...
    framings: [
      {
        ...
        note:
          '这一支明确把人格当作成就：一个个体可以是人类而仍然不是人格。人格是要去达成的地位，达成的办法是履行由自己的身分所界定的那些义务；达没达成，看的是习惯性行为养成的品性——条目卷首所引门基蒂的一句话正是立此意。条目还提出一个更强的主张：在这种道德里义务胜过权利，而不是相反，并把它与西方社会的道德体系对置——这是撰稿人本人的比较判断，不是学界的中立描述。',
        sourceIds: ['PH-1'],
      },
      {
        ...
        note:
          '这一支先把问题拆开，其中两问与这里最相关：人格问题——成为一个人格、而不是一件不具人格的东西，是怎么一回事；我们这些人身上有什么是非人格者所没有的。持续问题——一个人格要从一个时刻持续到另一个时刻，需要什么。条目强调这两问大体上互相独立。这里的人格问题要的是「人格」一词的定义与适用条件，不是一个可以做得更好或更差的地位。',
        sourceIds: ['PH-2'],
      },
    ],
    caution:
    ...
    pending: [
      'SEP African Ethics 由吉耶凯（Kwame Gyekye）撰写，非洲共同体主义伦理学一栏里那两条主张都出自他本人。要区分门基蒂的强共同体主义与吉耶凯自己的温和共同体主义，必须核对 Menkiti 1984 与 Gyekye 1997 原文，本轮没有做——因此「人格、共同体与 Ubuntu」页上的三条立场目前仍缺各自的独立来源，不能用这一条来支撑其中任意一条。',
