...
export const concepts: Concept[] = [
  {
    ...
    detail:
      '这是一个关于世界结构的命题，不是关于我们能算出什么的命题。决定论的世界可以完全无法预测：初始条件测不准，混沌会把微小误差放大到不可用；反过来，含有随机环节的世界也可以在统计上高度可预测。哲学史上对它最常见的两种混淆，正是可预测性与命定。',
    distinctions: [
      {
        from: '宿命论',
  ...
  },
  {
    ...
    detail:
      '在技术伦理里它多半作为被离弃的假设出现：另一条线索强调技术发展是人的选择造成的结果，尽管未必是任何人所打算的结果。这条线索并不因此说技术无关紧要，而是要求把设计、劳动、资本、制度与使用实践都写进解释。',
    distinctions: [
      {
        from: '决定论（因果决定论）',
      ...
      {
        from: '工具中立论',
        note: '主张技术只是中性工具、好坏取决于使用者。它与技术决定论方向相反，却常被同一个人交替使用；二十世纪的技术哲学分别批评了两者。',
      },
      {
        from: '「技术无关紧要」',
  ...
  },
  {
    ...
    short: '一个信念被持有时所具有的、使它够得上称为知识的那种理由。',
    detail:
      '中文这个词与政治哲学里的「正当性」毫无关系，本库把两者分列。英文 justification 的日常义是「已经为它作过辩护」，但认识论上的这个条件并不要求持信念的人事先给出过一套辩护；它问的是这个信念在其处境中是否被恰当支持。内在论与外在论的分歧，正在于「恰当支持」是否要求当事人自己能够取用。',
    distinctions: [
      {
        from: '政治正当性',
      ...
      {
        from: '为真',
        note: '有理由的信念可以是假的，碰巧为真的信念也可以毫无理由。把二者绑在一起就看不出盖梯尔问题在难什么。',
      },
      {
        from: '「已经作过辩护」',
  ...
  },
  {
    ...
    short: '对自己生活的某个领域有权自行决定，并且行动出于与她自己的立场相一致的动机。',
    detail:
      '「她自己的立场」由什么构成，是各家说明的分歧点：有的用高阶欲望（我希望哪个欲望推动我行动），有的用评价判断（哪些行动最值得做），还有的要求两者之间也协调。共同点是，仅有一个当下最强的欲望还不足以让行动成为自主的。这个词在政治语境里指群体自我治理，与个人对自己生活的权威只是类比关系。',
    distinctions: [
      {
        from: '随机或无因的选择',
  ...
  },
  {
    ...
    distinctions: [
      ...
      {
        from: '共同体中的人格',
        note: '非洲伦理学讨论的 personhood 是一种可以达成也可能未达成的道德地位，不是持续条件。',
      },
      {
        from: '自我感',
  ...
  },
  {
    ...
    short: '在若干非洲伦理学论述中，人格是通过参与共同生活、履行角色义务而逐步达成的道德地位，不是出生即完备的属性。',
    detail:
      '门基蒂的表述最常被引：传统非洲的各个社会通常接受人格必须被获得，且其获得程度与一个人通过履行其位置所规定的各项义务而参与共同生活的程度成正比——从幼年那种缺乏道德功能的「它」的地位，转为后来那种具备成熟伦理感的「人」的地位。这个说法内部有争论：把人格说成有程度的成就，是否会削弱每个人不可取消的地位，以及它能否与个人权利和批判能力相容。',
    distinctions: [
      {
        from: '人格同一性',
  ...
  },
  {
    ...
    short: '我们最好的科学理论所描述的东西——包括其中关于不可观察者的部分——大致为真且确实存在。',
    detail:
  ...
  },
  {
    ...
    detail:
      '被放弃的一端是种族自然主义：把种族看作可遗传的生物—行为本质，既为一个种族的全体成员所共有、又能解释其行为与文化倾向。哲学家与科学家在反对它上已形成共识，分歧从这里才开始：种族怀疑论认为既然生物本质不存在，任何意义上的种族都不存在；另一些立场主张种族是被建构出来的实在类别，或可用人群遗传学重新界定。与本体问题并列的还有规范问题——应当取消这个范畴，还是保留它。',
    distinctions: [
      {
        from: '科学实在论',
  ...
  },
  {
    ...
    short: '现象只在条件中生起与成立，找不到独立自立、不依赖他者的本性。',
    detail:
      '中观把它推到最强：龙树所否认的是 svabhāva——「以自性存在」意谓属于世界的基本家具，不依赖任何别的存在者，构成本体依赖链的终点；他论证没有这样的终点。同时他并不由此宣称因果不成立，而是说我们对因果关系的理解建立在一个错误前提上，即因与果各自以自性存在、彼此独立并独立于认知的心。早期教说的形态更近于「苦有其原因与条件」这一条。',
    distinctions: [
      {
        from: '「一切皆幻」',
    ...
    sources: [
      {
        ...
        checkedOn: '2026-09-11',
        supports:
          '§2 说明空是「空掉 svabhāva」，并把「以 svabhāva 存在」解为属于世界的基本家具、独立于其他一切存在者、构成本体依赖链的终点；龙树论证没有这样的终点。§3.1 说明他考察因果的各种可能关系后并不结论因果不可能，而是我们的因果理解基于一个错误前提——因与果以各自的 svabhāva 存在、彼此独立且独立于认知的心。',
      },
      {
        id: 'CPT-PS-2',
        title: 'Buddha（SEP）',
  ...
  },
  {
    ...
    detail:
      '本库对同一件事出现过三种叫法（修养、工夫、修身），侧重不同而所指相连；它们都不是先立一套理论再去应用。朱熹的人性论解释了为什么同一条路径对不同人难度不同：每个人的基本倾向受其气质禀赋、家庭与社会环境等条件制约，由此形成各不相同的性情、才智与修养资质。王阳明一路则把知与行合为一事，认为理不在心外，因而伦理学的理论研究并非实践的前提——这条批评针对的是把学理当作入门条件，不是取消工夫。',
    distinctions: [
      {
        from: '相容论',
        note: '把修养论直接归入自由意志争论的某一方，等于把它没有提出的问题塞给它；两者关心的检验也不同。',
      },
      {
        from: '自我提升技巧',
  ...
  },
  {
    ...
    detail:
      '常被列入的候选是知觉、推理、类比与证言，另有「假定」（arthāpatti）、「非认知」（anupalabdhi）等更有争议的候选。分歧不是术语之争：胜论与佛教诸家否认证言是独立的认识手段，理由涉及转述的可靠性最终仍要回到某个原初知者的知觉或推理。翻译上还有一层麻烦——jñāna 常被译作 knowledge，但梵语用法允许「假的 jñāna」，英文 knowledge 不允许，所以译作「认知」更稳。',
    distinctions: [
      {
        from: '三段论',
        note: '五支论证与认识手段的分析有自己的真理条件与问题组织，不是欧洲逻辑的翻译版本。',
      },
      {
        from: '「信息来源」清单',
  ...
  },
  {
    ...
    detail:
      '同一件事的两个版本就能看出难处：告诉你比赛结果的若是你已知高度可靠的体育记者，你的信念显然有理由；若是一个素不相识的人，而你既不知他是否常说真话、也没有理由怀疑他，你的信念是否有理由就不清楚了。还原论要求听者另有独立理由支持说话者可靠，非还原论主张在没有反面理由时接受他人所说本身即为正当；此外还有传递与生成之别，以及个人主义与反个人主义之争。',
    distinctions: [
      {
        from: '专家意见',
  ...
  },
  {
    ...
    short: '行动者仅因行动是她的、且她明白它错在哪里，就配得谴责；这种配得不依赖谴责会带来的任何好处。',
    detail:
  ...
  },
  {
    ...
    term: '道德运气',
    original: 'moral luck',
    short: '超出行动者控制范围的因素，仍然改变我们对她的道德评价。',
    detail:
      '问题的一个常见起点是康德式直觉：善良意志的价值不在于它成就了什么，即使命运不佑、它竭尽全力仍一无所成，它也像宝石那样自身发光。日常评价却确实随结果、处境、性格与因果史而变。两边都要付代价：严格坚持控制原则，会使大量日常归责失效；接受运气改变责备，则要解释这在什么意义上还算公平。',
    distinctions: [
      {
        from: '认知运气',
    ...
    sources: [
      {
        ...
        locator: '§1 Generating the Problem of Moral Luck，所引康德《奠基》段落',
        checked: 'verified',
        checkedOn: '2026-09-11',
        supports:
          '该节以康德的引文起头：善良意志之为善不在于它所促成或达成之事，即使因命运不佑而一无所成，它仍像宝石那样自身发光，有用或无用都不增减其价值——道德免于运气的想法由此获得启发。',
      },
      {
        id: 'CPT-ML-2',
        title: 'Moral Responsibility（SEP）',
  ...
  },
  {
    ...
    short: '一个信念既真又有理由，却只是碰巧为真，因此仍不算知识。',
    detail:
  ...
  },
  {
    ...
    short: '说一个人「有责任」至少是三件事：这件事出自她（可归属性）、她可以被要求说明理由（可要求说明）、她可以被追究并承担后果（可追究性）。',
    detail:
  ...
  },
  {
    ...
    term: '相对主义',
    original: 'relativism',
    short: '某个领域里的真或值要相对于一个参数（文化、概念框架、语言、评价者）才成立，没有超出全部参数的绝对标准。',
    detail:
      '标准的定义方式是共变：某个现象 x（价值、认识或伦理规范、判断，甚至世界）依赖并随某个独立变量 y（范式、文化、概念框架、信念系统、语言）而变。用否定的方式说更清楚：它反对绝对主义（至少某些真或值适用于一切时地）、客观主义（真独立于特定时地的判断与信念）、一元论（同一争议上不能有多于一个正确判断），以及把真理的客观性与唯一性合在一起的实在论。各版本的分歧在于相对化的参数是什么、范围有多大（全局还是局部、强还是弱）。',
    distinctions: [
      {
        from: '主观主义',
  ...
  },
  {
    ...
    detail:
      '多重实现正是它的主要动因：它给出一种「更具包容性、不以物种为中心」而又与物理主义相容的心灵理论。它面对的经典反对是缺失感受质——似乎可能存在与常人功能等价、却没有任何感受性质的存在者。',
    distinctions: [
