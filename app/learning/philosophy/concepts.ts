...
export const concepts: Concept[] = [
  {
    ...
    detail:
      '这是一个关于世界结构的命题，不是关于我们能算出什么的命题。决定论的世界可以完全无法预测：初始条件测不准，混沌会把微小误差放大到不可用；反过来，含有随机环节的世界也可以在统计上高度可预测。',
    distinctions: [
      {
        from: '宿命论',
      ...
      {
        from: '可预测性',
        note: '是认知能力的问题——谁能测量、能算多久；决定论问的是世界是否只有一条路。算不出来，不等于路不止一条。',
      },
      {
        from: '因果性',
  ...
  },
  {
    ...
    detail:
      '哲学讨论里它的论证通常不走物理因果，而走逻辑或神学：未来命题现在已有真值，或全知者早已知道结果。因果决定论只是通向它的三条路线之一，不是同一个主张。',
    distinctions: [
      {
        from: '决定论',
        note: '两者的分界，以及「从决定论推不出宿命论」的理由，完整写在「决定论」那一条。这边只补一句代价：混用二者，最常见的后果是让「反正都定了」冒充结论。',
      },
      {
        from: '认命的态度',
  ...
  },
  {
    ...
    detail:
      '二十世纪的技术伦理多半是在离开这个假设之后展开的：它转而强调技术的发展是人的选择造成的结果，尽管未必是任何人原本打算的结果。解释因此要把设计、劳动、资本、制度与使用实践一并算进来。',
    distinctions: [
      {
        from: '决定论（因果决定论）',
      ...
      {
        from: '工具中立论',
        note: '主张技术只是中性工具、好坏取决于使用者。它与技术决定论方向相反：一个说技术自行推动社会变化，一个说技术本身什么也不决定。先讲「技术改变了一切」、再讲「技术只是工具，看人怎么用」，等于在两个不能并存的说法之间来回站队。二十世纪的技术哲学对这两个说法都提出过批评。',
      },
      {
        from: '「技术无关紧要」',
  ...
  },
  {
    ...
    detail:
      '它通常被列为知识的三个条件之一（信念为真、当事人相信它、这个信念有正当性）。但三条合起来是否已经够用，正是盖梯尔问题要追问的——有理由的真信念仍可能只是碰巧撞对，所以不能反过来把「有正当性」直接定义成「够得上知识」。至于「恰当支持」要不要落在当事人这一侧，则是内部主义与外部主义的分歧：内部主义主张它取决于当事人的心理状态，或取决于他一经反思就能知道的条件；外部主义否认这一点。',
    distinctions: [
      {
        from: '政治正当性',
    ...
    sources: [
      {
        ...
        checkedOn: '2026-09-11',
        supports:
          '§1.3.1 明确指出 justification 这个标签是二十世纪才通行的叫法，容易误导：按日常义「被辩护」意味着已经完成一次成功的辩护工作，而主张知识有正当性条件的认识论者通常不作此解。§1.3.2 是内部主义／外部主义之分的出处。',
      },
    ],
  },
  {
    ...
    detail:
      '一个词遮住了至少三个问题：人们事实上是否信从这个秩序（韦伯意义上的描述性问题）；强制性权力是否可被正当化；以及公民是否因此负有服从义务。这三问的答案彼此不决定，必须分开回答，否则一句「这个政权有没有正当性」会同时被当成三个不同的判断在用。',
    distinctions: [
      {
        from: '合法性（符合法律）',
  ...
  },
  {
    ...
    detail:
      '至于什么使一个决定真的算「她自己作出的」，各家说明并不一致。融贯论这一路要求行动出于与她自己的立场相协调的动机；至于「她自己的立场」由什么构成，这一路内部又有分歧：有的用高阶欲望（我希望哪一个欲望推动我行动），有的用评价判断（哪些行动最值得做），还有的要求两者之间也协调。它们的共同点是：仅仅有一个当下最强的欲望，还不足以让行动成为自主的。',
    distinctions: [
      {
        from: '随机或无因的选择',
  ...
  },
  {
    ...
    distinctions: [
      {
        from: '个人自主',
        note: '关系自主不否认自我治理，分歧在这项条件该在哪里检验：一边看动机与她自己的立场协调不协调，另一边主张承认、可得资源与她所处的关系也得算进这次检验。',
      },
      {
        from: '「受关系影响就不自主」',
  ...
  },
  {
    ...
    detail:
      '「人格同一性」这个名目下不是一个问题，而是一组彼此松散相连、且常不被分开的问题。哲学之外，它常指那些「使我成为我这种人」的特征，这叫刻画问题；哲学讨论多数针对持续问题，也就是一个人凭什么跨过时间仍算同一个人。两者的答案互不决定：弄清了什么使我成为这种人，并没有回答未来那个人凭什么还是我。',
    distinctions: [
      {
        from: '身份认同（性别、族群、国族）',
      ...
      {
        from: '共同体中的人格',
        note: '非洲伦理学讨论的 personhood 问的是一个人在共同体中取得什么样的道德地位——那是一个有程度、可被承认也可被拒绝承认的问题，与跨时间还是不是同一个人无关。',
      },
      {
        from: '自我感',
  ...
  },
  {
    ...
    detail:
      '最常被引用的是门基蒂的表述：传统非洲的各个社会通常认为人格要靠获得。一个人越切实地履行自己位置上的那些义务、越深地参与共同生活，获得的人格就越多；起点是幼年那种还没有道德功能的「它」，终点是具备成熟伦理感的「人」。这是其中一家的主张，不是整个传统的共识：把人格说成有程度的成就，会被追问它是否削弱了每个人不可取消的地位、能否与个人权利和批判能力相容。《人格、共同体与 Ubuntu》一页记录了反对这种渐进说法的立场。',
    distinctions: [
      {
        from: '人格同一性',
        note: '问的是同一个人跨时间的持续条件，答案对「谁算共同体的完整成员」不起作用；反过来，一个人在道德上取得了什么地位，也定不了他失忆之后还是不是原来那个人。',
      },
      {
        from: '「集体高于个人」的标签',
  ...
  },
  {
    ...
    detail:
      '「实在论」本身只是「主张某类东西真实存在」的通名：可以对感觉材料、对桌椅、对数与集合分别做实在论者。科学实在论特别的地方在于，它把这份承诺一路推到电子、场、基因这类不可观察的理论设定上——争论就集中在这一步。承诺可分三个方向：形而上学上有一个不依赖心灵的实在；语义上把理论的陈述按字面理解，说「有电子」就是在说真有电子这种东西；认识上把理论当作关于可观察者与不可观察者的知识。反实在论只需在其中一个方向上反对。',
    distinctions: [
      {
        from: '常识',
      ...
      {
        from: '关于种族的实在论',
        note: '那里争的是「种族」这个社会分类范畴指称什么，用来判断的证据与理论预测的成功无关；把两处的「实在论」当成同一个立场，会以为反对其中一个就得反对另一个。',
      },
    ],
  ...
  },
  {
    ...
    detail:
      '已经被放弃的一种主张是种族自然主义：把种族看作一种可遗传的生物—行为本质，这种本质为某个种族的全体成员共有，并能解释他们的行为与文化倾向。反对它已是哲学家与科学家的共识，分歧从这里才开始：种族怀疑论认为既然生物本质不存在，任何意义上的种族都不存在；另一些立场主张种族是被建构出来的实在类别，或可用人群遗传学重新界定。与本体问题并列的还有规范问题——应当取消这个范畴，还是保留它。',
    distinctions: [
      {
        from: '科学实在论',
  ...
  },
  {
    ...
    detail:
      '同一个词在不同阶段承担的分量不同。早期教说里它的形态较朴素，四圣谛第二条就是一例：苦的生起有其原因与条件。中观（龙树一系）把它推到最强，据此否认 svabhāva（自性）——说某物「以自性存在」，意思是它是世界的基本构件，不依赖任何别的存在者，是一连串依赖关系追到底之后的终点；龙树论证没有这样的终点。他并不因此宣称因果不成立，而是说我们对因果的理解建立在一个错误前提上：以为因与果各自以自性存在、彼此独立，也独立于认知它们的心。',
    distinctions: [
      {
        from: '「一切皆幻」',
        note: '否认自性不是否认因果，也不是否认日常对象与言说；被拒绝的只是「这些东西由自身成立、不依赖条件」这一点。',
      },
      {
        from: '决定论',
  ...
  },
  {
    ...
    detail:
      '修养、工夫、修身是同一件事的三种叫法，侧重不同而所指相连，这里不加区分。朱熹的人性论解释了为什么同一条路径对不同人难度不同：每个人的基本倾向受其气质禀赋、家庭与社会环境等条件制约，由此形成各不相同的性情、才智与修养资质。王阳明一路则把知与行合为一事，认为理不在心外，因而伦理学的理论研究并非实践的前提。',
    distinctions: [
      {
        from: '相容论',
  ...
  },
  {
    ...
    distinctions: [
      {
        from: '三段论',
        note: '印度的五支论证（一种分五步走的论证格式）连着一整套认识手段的分析，自成一系：这套分析要回答的问题、评判论证好坏的标准，都与欧洲逻辑不同，不是同一套东西换了名词。',
      },
      {
        from: '「信息来源」清单',
  ...
  },
  {
    ...
    detail:
      '同一件事的两个版本就能看出难处：告诉你比赛结果的若是你已知高度可靠的体育记者，你的信念显然有理由；若是一个素不相识的人，而你既不知他是否常说真话、也没有理由怀疑他，你的信念是否有理由就不清楚了。还原论要求听者另有独立理由支持说话者可靠，非还原论主张在没有反面理由时接受他人所说本身即为正当。除这一条争线外还有两条：证言是只把已有的知识从说话者传给听者，还是本身也能生成新知识；判断听者的信念有没有理由，能不能只看听者这一侧的状态。',
    distinctions: [
      {
        from: '专家意见',
  ...
  },
  {
    ...
    detail:
      '这个界定出自佩雷布姆，他同时点出了「基本」二字排除什么：不只排除「谴责有用」这类后果论理由，也排除契约论式的理由——这种应得不以任何进一步的理由为条件。责任怀疑论针对的正是这一种责任，而不是全部责任实践。佩雷布姆本人拒绝以应得为基础的责备，却主张若干常规责备实践可以建立在「不诉诸应得的道德考量」上，例如保护潜在受害者、修复人际与道德共同体中的关系、以及道德养成。',
    distinctions: [
      {
        from: '一切谴责与惩罚',
  ...
  },
  {
    ...
    detail:
      '盖梯尔的论证由此得出：有理由的真信念即使是知识的必要条件，也不是充分条件。一条自然的回应是给分析加上明确的「反运气」条件，但这类条件会改动整个分析的结构——只要要求「信念之为真并非仅出于运气」，这一条就已蕴含信念为真与相信本身，原有的三条件不再各自独立。',
    distinctions: [
      {
        from: '道德运气',
        note: '那里问的是运气之下评价一个人还算不算公平，这里问的是一个信念够不够称为知识。把两者当成同一个「运气问题」，就会拿归责的直觉去判断知识条件。',
      },
      {
        from: '瞎猜对了',
  ...
  },
  {
    ...
    detail:
      '这一分法起于沃尔夫与沃森之争。在「真我」理论里，一个人对可归属于其真我的行为负责；所谓可归属于真我，是说她既能依自己的意志支配行为，又能依自己的评价系统支配意志。负责的行动者因此不是被当下最强的欲望推动的，而是被她所认可的欲望推动的。这三个名称在不同作者笔下并不指同一件事：肖梅克把可归属性对应品格、可追究性对应对他人的顾念、可要求说明对应评价判断；史密斯与希罗尼米用「可要求说明」指更接近可归属性的立场；佩雷布姆用它指一种更容纳责任怀疑论的责任。这里统一采用这三个中文译名，遇到具体作者时再说明他自己的用法。',
    distinctions: [
      {
        from: '因果上的原因',
  ...
  },
  {
    ...
    distinctions: [
      {
        from: '主观主义',
        note: '把真或正当相对于每一个个人；一般所说的相对主义相对于群体。代价不同：退到个人这个参数，判断就不再能在人与人之间互相校对，而这种互主观性正是许多相对主义者看重的长处。',
      },
      {
        from: '描述性的文化差异',
  ...
  },
  {
    ...
    detail:
      '把角色而不是材料当作判准，主要动因是多重实现：只有这样，才可能有一种「更具包容性、不以物种为中心」而又与物理主义相容的心灵理论。它面对的经典反对是缺失感受质——感受质指体验本身的那种质地，疼是什么滋味、看到红是什么样子；这条反对说，似乎可能存在一种与常人功能完全等价、却没有任何这类质地的存在者。',
    distinctions: [
      { from: '类型同一论', note: '把某类心理状态直接等同于某类物理状态，因此只要有一种别的材料实现了同一状态，它就被推翻。' },
