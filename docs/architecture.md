...
最近一次正式网站发布是 Worker Version ID `9fe2c73f-0563-4830-a386-6dffb45f8792`（2026-09-19，哲学专区教学重构：具体入口／默认已知／回到问题三层、概念解释前置、导航页导语与建议阅读顺序、推荐路线 11 步加支线层、15 组译名统一），对应提交 `c997276`，使用 `pnpm deploy:only`，未触碰远程数据库。同一轮的主体发布是 `af3f8505-1431-4715-aa4b-be2e9ed72d78`（对应 `8f30bc3`）。再往前是 `43e4d315-6f83-455c-9a40-8f2837838a78`（2026-09-15，哲学库全范围复审，对应 `96d6072`）、`18d5d178-3f3e-4978-9978-ff8cabfc1ff7`（2026-09-13，内容整改轮）、`a5607b45-d9c0-4369-929c-a38b43f4699b`（2026-09-11，哲学知识库 V2，对应 `f6d9e7e`）、`e2ae9304-77d7-4303-93d7-7b0ec91cae18`（2026-09-09，对应 `cb9b966`）、`70b5ff22-d27a-423e-8fc5-e4dfaf025141` 与 `17741be9-d6dd-4208-8efd-71781982026e`。
